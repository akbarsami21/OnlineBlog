...
<div class="row">
	...
	if (posts.size() == 0) {
		out.println("<h3 class='display-3 text-center'>No post In This Catergoy</h3>");
	}
		...
		<div class="card">
			...
			<div class="card-footer text-center">
				...
				<a href="#!" class="btn btn-outline-primary btn-sm"><i
					...
					href="showPost.jsp?postId=<%=p.getPid()%>"
					class="btn btn-outline-primary btn-sm">ReadMore</a>
